...
export const generateCertificatePDFKit = async (
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.text(
        "in recognition of dedication, perseverance, and commitment to continuous learning.",
        80,
        360,
        { align: "center", width: PAGE_WIDTH - 160 }
      );
      ...
      doc.text(
        "This certificate is digitally verified by CodeTutor LMS and can be authenticated online.",
        0,
        PAGE_HEIGHT - 85,
        { align: "center" }
      );
